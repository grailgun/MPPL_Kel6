...
<div class="card bg-dark text-white mx-5">
    <img src="{{asset('img/gambar4.jpeg')}}" class="card-img"  alt="gambar ruko" style="width:1320x; height:600px;">
...
<div class="row row-cols-1 row-cols-md-4 mx-5">
    <div class="col mb-4">
        <div class="card h-100">
            <img src="{{asset('img/gambar1.jpeg')}}" class="card-img-top" alt="gambar product">
            <div class="card-body">
    ...
    <div class="col mb-4">
        <div class="card h-100">
            <img src="{{asset('img/gambartgs.jpeg')}}" class="card-img-top" alt="...">
            <div class="card-body">
    ...
    <div class="col mb-4">
        <div class="card h-100">
            <img src="{{asset('img/gambar1.jpeg')}}" class="card-img-top" alt="gambar 1">
            <div class="card-body">
